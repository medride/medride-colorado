    ...
    <div className="flex w-full items-center justify-between bg-gray-800 py-2 px-8 text-white lg:pr-10 lg:pl-10 2xl:pr-32">
      ...
      <div className="flex items-center space-x-2 lg:space-x-6">
        ...
        <div className="phone flex items-center">
          ...
          <p className="pl-4 md:text-base xl:text-lg">
      ...
      <div className="flex space-x-3 md:space-x-4">
        ...
        {/* LinkedIn */}
        <Link href="https://www.linkedin.com/company/medride-transportation-llc/">
          <a target="_blank">
            <svg
              role="img"
              viewBox="0 0 24 24"
        ...
        {/* Facebook */}
        <Link href="https://www.facebook.com/medridetransportation">
          <a target="_blank">
            <svg
              role="img"
              viewBox="0 0 24 24"
